...
<body>
    ...
    <div class="text-center mt-3 pt-3 bg-white">
        ...
        <h3 class="alert alert-success d-inline-block">A</h3>
        @elseif(($nilai >70) and ($nilai <= 84))
        <h3 class="alert alert-success d-inline-block">B</h3>
        @elseif(($nilai >55) and ($nilai <= 69))
        <h3 class="alert alert-warning d-inline-block">C</h3>
        @elseif(($nilai >40) and ($nilai <= 54))
        <h3 class="alert alert-danger d-inline-block">D</h3>
        @elseif(($nilai >0) and ($nilai <= 39))
        <h3 class="alert alert-danger d-inline-block">E</h3>     
        @endif
